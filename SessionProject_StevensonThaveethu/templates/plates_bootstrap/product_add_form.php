        ...
        <div id="pageBodyProducts">
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              <form method="post" action="" enctype="multipart/form-data" id="formadd1">
                  ...
                  <button class="flex-no-shrink bg-blue hover:bg-blue-dark border-blue hover:border-blue-dark text-3xl border-4 text-white py-1 px-2 rounded" type="submit" form="formadd1">
                      Save
                  </button>
              </form>
              <?php if ($view['saved'] === 1): ?>
