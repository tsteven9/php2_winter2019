    ...
    <div class="w-full py-24 px-6 bg-grey-lighter relative z-10">
        ...
        <div class="container max-w-xl mx-auto text-left flex items-center flex-wrap">
            ...
            <div class="w-full md:w-2/3">
                <h1 class="text-2xl md:text-4xl text-grey-darkest mb-3">Method Not Allowed</h1>
                <p class="text-md md:text-lg text-grey-dark leading-normal">
                    Let's go back <a href="<?php echo $view['urlbaseaddr'] ?>index">HOME</a>!
                </p>
                <p class="text-md md:text-lg text-grey-dark leading-normal">Sorry, but this method is not allowed on this page.</p>
                <?php foreach($view['vars'] as $key => $value): ?>
                    <p class="text-md md:text-lg text-grey-dark leading-normal">Allowed method: <?php echo $value ?></p>
                <?php endforeach; ?>
                <p class="text-md md:text-lg text-grey-dark leading-normal">Let's go back <a href="<?php echo $view['urlbaseaddr'] ?>index">HOME</a>!</p>
            </div>
        </div>
